...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:kab_kota'])->group(function () {
        ...
        Route::post('kab-kota/data-mente/{kab_kota_id}/{tingkat_aparatur}/tingkat-kabkota', [MenteController::class, 'tingkatKabKota'])->name('kab-kota.data-mente.tingkat-kabkota');
        Route::post('kab-kota/data-mente/{provinsi_id}/{tingkat_aparatur}/tingkat-provinsi', [MenteController::class, 'tingkatProvinsi'])->name('kab-kota.data-mente.tingkat-provinsi');
