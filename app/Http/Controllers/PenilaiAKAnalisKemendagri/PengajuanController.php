...
namespace App\Http\Controllers\PenilaiAKAnalisKemendagri;
...
class PengajuanController extends Controller
{
    ...
    {
        return view('penilai-ak-analis-kemendagri.data-pengajuan.index');
    }
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    return view('penilai-ak-analis-kemendagri.data-pengajuan.buttons', compact('row'))->render();
                })
    ...
    public function show($id)
    {
        ...
        return view('penilai-ak-analis-kemendagri.data-pengajuan.show', compact('user', 'rekapitulasiKegiatan', 'penetapanAngkaKredit', 'penetapanAngkaKreditOld'));
    }
