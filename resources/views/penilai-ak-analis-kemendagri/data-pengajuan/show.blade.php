...
@section('js')
    ...
    <script>
            ...
            swal({
                ...
                preConfirm: () => {
                    return new Promise(function(resolve) {
                        $.ajax({
                                type: 'POST',
                                url: url('/penilai-ak-analis-kemendagri/data-pengajuan/' +
                                    id +
                                    '/simpan-penetapan'),
                                processData: false,
                                contentType: false,
        ...
        $('.ttd').click(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: url('/penilai-ak-analis-kemendagri/data-pengajuan/' + $(this).data('id') + '/ttd'),
                processData: false,
                contentType: false,
                data: postData,
        ...
        $('.send-to-penetap').click(function(e) {
            ...
            swal({
                ...
                preConfirm: async () => {
                    return await $.ajax({
                        type: "POST",
                        url: url('/penilai-ak-analis-kemendagri/data-pengajuan/' + $(this).data(
                                'id') +
                            '/send-to-penetap'),
                        dataType: "JSON",
                    });
