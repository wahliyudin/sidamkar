                            ...
                            @forelse ($informasis as $informasi)
                                <div class="accordion-item">
                                    <div class="d-flex flex-column accordion-header py-3 px-2"
                                        ...
                                        <div class="ps-2 pt-2">
                                            <h6 class="accordian-title" style="color: #000000;">Judul :
                                                {{ $informasi->judul }}</h6>
                                        </div>
                                    </div>
                    ...
                    <form class="row" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <div class="form-check">
                                <input class="form-check-input checkbox" type="checkbox" name="tujuan[]" id="tujuan1"
                                    value="aparatur">
                                Aparatur
                            </div>
                            <div class="form-check">
                                <input class="form-check-input checkbox" type="checkbox" name="tujuan[]" id="tujuan2"
                                    value="8">
                                Kabupaten/kota
                            </div>
                            <div class="form-check">
                                <input class="form-check-input checkbox" type="checkbox" name="tujuan[]" id="tujuan3"
                                    value="9">
                                Provinsi
                            </div>
                        </div>
