            ...
            <div class=" card-header">
                <div class="row">
                    ...
                    <div class="col-md-4 kanan" >
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Tambah Informasi</button>
                    </div>
                </div>
            </div>
        <div class="card-body">    
                ...
                <div class="col-md-12 mb-2">
                  ...
                  <div class="col-md-12 mb-2">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="tujuan" id="tujuan1" value="aparatur" checked>
                        Aparatur
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tujuan" id="tujuan2" value="kab/kota" >
                        Kab/kota
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tujuan" id="tujuan3" value="provinsi" >
                        Provinsi
                    </div>
                    <div class="form-check">
