...
@section('content')
    <section class="section">
        <div class="card py-2 overflow-auto">
            ...
            <div class="card-body">
                <table id="penilai-damkar-kemndagri" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>Nama</th>
                            <th>NIP</th>
...
@section('js')
    ...
    <script>
        $('#penilai-damkar-kemndagri').dataTable().fnDestroy();
        table = $('#penilai-damkar-kemndagri').DataTable({
            responsive: true,
            serverSide: true,
            processing: true,
            ajax: {
                url: url('/penilai-ak-damkar-kemendagri/data-pengajuan/datatable'),
                type: "POST",
                data: {
                    "_token": "{{ csrf_token() }}"
                }
                    ...
                    preConfirm: async (value) => {
                        return new Promise(function(resolve) {
                            $.ajax({
                                    type: 'POST',
                                    url: url(
                                        "/penilai-ak-damkar-kemendagri/data-pengajuan/" +
                                        user_id +
                                        "/tolak"),
                                    data: {
                                        catatan: value
