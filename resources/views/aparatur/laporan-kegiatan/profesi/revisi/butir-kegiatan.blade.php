<div class="modal fade" id="revisi{{ $butirKegiatan->id }}" tabindex="-1" role="dialog" aria-labelledby="revisiTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body px-4">
                <form action="" class="form-kegiatan{{ $butirKegiatan->id }}" method="post">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="keterangan" rows="3">{{ $butirKegiatan->laporanKegiatanProfesi->detail_kegiatan }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <button type="button" data-rencana="{{ $butirKegiatan->id }}"
