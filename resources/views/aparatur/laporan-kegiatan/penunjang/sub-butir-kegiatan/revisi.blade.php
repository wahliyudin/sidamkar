                                ...
                                <div class="d-flex flex-column pe-3 ps-1" data-simplebar
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex flex-column mt-3">
                                            <span
                                                style="color: #000; font-weight: 700;">{{ $laporanKegiatanJabatan->subButirKegiatan->butirKegiatan->subUnsur->unsur->nama }}</span>
                                            <span
                                                style="color: #000; margin-left: 1rem;">{{ $laporanKegiatanJabatan->subButirKegiatan->butirKegiatan->subUnsur->nama }}</span>
                                            <ul style="margin-left: 1.5rem;">
                                                <li style="color: #000;">
                                                    {{ $laporanKegiatanJabatan->subButirKegiatan->nama }}
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
