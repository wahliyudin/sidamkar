<div class="modal fade" id="riwayatKegiatan{{ $subButirKegiatan->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex flex-wrap gap-3 justify-content-center">
                                    @foreach ($subButirKegiatan->laporanKegiatanProfesi->dokumenKegiatanProfesis as $dokumenKegiatanProfesi)
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" readonly name="keterangan" rows="3">{{ $subButirKegiatan->laporanKegiatanProfesi->detail_kegiatan }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
