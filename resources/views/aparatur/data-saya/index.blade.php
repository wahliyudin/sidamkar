                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="pen_terakhir form-select" name="pendidikan_terakhir">
                                            ...
                                            <option @selected(old('pendidikan_terakhir', $user->userAparatur?->pendidikan_terakhir) == '5') value="5">S3</option>
                                        </select>
                    ...
                    <div class="card-body">
                        <ul class="doc-wrapper">
                            @foreach ($user->dokKompetensis as $docKom)
                                <li class="doc-item">
                                    <a href="{{ route('data-saya.show-doc-kom', $docKom->id) }}" class="d-flex align-items-center">
                                        <span
