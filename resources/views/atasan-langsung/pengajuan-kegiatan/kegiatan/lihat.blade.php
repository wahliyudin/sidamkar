<div class="modal fade" id="lihat{{ $rencanaButirKegiatan->id }}" tabindex="-1" role="dialog" aria-labelledby="lihatTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-xl {{ isset($rencanaButirKegiatan->laporanKegiatanJabatan?->dokumenKegiatanPokoks) ? 'modal-lg' : '' }} modal-dialog-centered modal-dialog-centered"
        role="document">
        <div class="modal-content">
            <div class="modal-body px-4">
                @if (isset($rencanaButirKegiatan->laporanKegiatanJabatan?->dokumenKegiatanPokoks))
                    ...
                    <div class="d-flex wrapper-btn justify-content-end align-items-center mt-0">
                        ...
                        <button type="button" data-user="{{ $user->id }}"
                            data-id="{{ $rencanaButirKegiatan->id }}"
