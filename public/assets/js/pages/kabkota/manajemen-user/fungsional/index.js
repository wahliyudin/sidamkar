...
function tolak(id) {
    swal({
        ...
        preConfirm: async (value) => {
            ...
            return await $.ajax({
                type: 'POST',
                url: url('/kab-kota/manajemen-user/fungsional/' + id + '/reject'),
                data: {
                    _token: CSRF_TOKEN,
                    catatan: value
                },
...
function verifikasi(id) {
    swal({
        ...
        preConfirm: async () => {
            ...
            return await $.ajax({
                type: 'POST',
                url: url('/kab-kota/manajemen-user/fungsional/' + id + '/verification'),
                data: {
                    _token: CSRF_TOKEN
                },
                dataType: 'JSON'
...
function hapus(id) {
    swal({
        ...
        preConfirm: async () => {
            ...
            return await $.ajax({
                type: 'POST',
                url: url('/kab-kota/manajemen-user/fungsional/' + id + '/destroy'),
                data: {
                    _token: CSRF_TOKEN
                },
                dataType: 'JSON'
