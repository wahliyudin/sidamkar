$(document).ready(function () {
    ...
    //             `/provinsi/data-mente/${$($(this).find('.nama')).data('detail')}/show`
    //         ));
    //     });
    // });
    $.ajaxSetup({
    ...
    $(document).on('click', '.edit-mente', function () {
        ...
        $.ajax({
            type: "GET",
            url: url('/provinsi/data-mente/' + $(this).data('id') + '/edit'),
            dataType: "json",
    ...
    $('.simpan-mente').click(function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: url("/provinsi/data-mente/store"),
            processData: false,
            contentType: false,
            data: postData,
            success: function (response) {
    ...
    $('.simpan-edit-mente').click(function (e) {
        ...
        $.ajax({
            type: 'PUT',
            url: url("/provinsi/data-mente/" + $(this).data('id') + "/update"),
            data: {
