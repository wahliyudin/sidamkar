$(document).ready(function () {
    ...
    function loadData(search = null) {
        $.ajax({
            type: "POST",
            url: url('/laporan-kegiatan/penunjang/load-data'),
            data: {
                search: search
            },
            dataType: "json",
    ...
    $('.rekap').click(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: url('/laporan-kegiatan/penunjang/rekapitulasi'),
            dataType: "JSON",
            success: function (response) {
    ...
    $('.send-rekap').click(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: url('/laporan-kegiatan/penunjang/rekapitulasi/send-rekap'),
            dataType: "JSON",
            success: function (response) {
            ...
            return `
                <li class="accordian-list ">
                    <div class="d-flex align-items-center justify-content-between">
                        <a href="${url('/laporan-kegiatan/penunjang/' + butirKegiatan.id + '/show')}" class="link-butir">
                            <h6 class="accordian-title">
                                ${butirKegiatan.nama}
                            </h6>
                        </a>
    ...
    $('.send-skp').on('click', function () {
        ...
        if (nilai_skp == undefined) {
            ...
            $.ajax({
                type: "POST",
                url: url("/laporan-kegiatan/penunjang/send-skp"),
                data: data,
                success: function (response) {
