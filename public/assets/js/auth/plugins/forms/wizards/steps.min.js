    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                ...
                // btn = '<li><button type="submit" role="menuitem">{0}</button></li>',
                f = "";
            b.forceMoveForward || (
                    e = '<li><a href="#{0}" class="btn btn-light" role="menuitem">{1}</a></li>',
                    f += e.format("previous", b.labels.previous)),
                e = '<li><a href="#{0}" class="btn btn-primary" role="menuitem">{1}</a></li>',
                f += e.format("next", b.labels.next),
                b.enableFinishButton && (
                    e = '<li><a href="#{0}" class="btn btn-primary" style="display: none;" role="menuitem">{1}</a><button button type="submit" class="btn btn-primary" role="menuitem">{1}</button></li> ',
